...
const LoginPage = () => {
  return (
    // Outer container for centering and background gradient with dark mode support
    <div className="min-h-screen flex items-center justify-center  dark:from-gray-800 dark:to-gray-900 pb-60">
      {/* Login Card with dark mode styles */}
      <div className="bg-white p-8 rounded-lg shadow-2xl w-full max-w-md transform transition-all duration-500 hover:scale-105 dark:bg-gray-700 dark:shadow-none dark:border dark:border-gray-600">
        ...
        {/* Optional Image Placeholder (uncomment to use) */}
        ...
        {/* Social Login Separator (adjusted spacing) */}
        ...
        {/* Social Login Buttons (centered if only 2) */}
        <div className="mt-6 flex justify-center space-x-4"> {/* Using flex and space-x for centering two items */}
          {/* Google */}
          <div>
            <button className="w-full min-w-[150px] flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-150 ease-in-out dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-900 dark:focus:ring-indigo-500">
